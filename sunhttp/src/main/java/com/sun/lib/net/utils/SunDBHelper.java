 ...
 */
public class SunDBHelper {
    /*数据库名称*/
    private final String DB_NAME = "com-r-sun-http.db";
    private final int DB_VERSION = 1;
    private static SunDBHelper instance;
    ...
    public static SunDBHelper get() {
        if (instance == null) {
            synchronized (SunDBHelper.class) {
                if (instance == null) {
                    instance = new SunDBHelper();
                }
            }
        }
        return instance;
