package com.sun.lib.net.load.download;


import android.os.Handler;


import com.sun.lib.net.SunDownLoad;
...
public class DownloadObserver<T extends Download> implements DownloadProgressCallback, Observer<T> {
    ...
    public void onSubscribe(@NonNull Disposable d) {
        ...
        SunDBHelper.get().insertOrUpdate(download);//更新数据库
    ...
    public void onError(Throwable e) {
        ...
        SunDownLoad.get().removeDownload(download, false);//移除下载
        SunDBHelper.get().insertOrUpdate(download);//更新数据
