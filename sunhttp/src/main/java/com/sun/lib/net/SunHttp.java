...
import com.sun.lib.net.callback.UploadCallback;
import com.sun.lib.net.cancel.RequestManagerImpl;
import com.sun.lib.net.load.upload.UploadRequestBody;
import com.sun.lib.net.observer.HttpObservable;
import com.sun.lib.net.retrofit.NetMethod;
...
public class SunHttp {
    ...
    private void disposeHeader() {
        ...
        if (!header.isEmpty()) {
            ...
            for (String key : header.keySet()) {
                header.put(key, SunRequestUtil.getHeaderValueEncoded(header.get(key)));
            }
        }
    ...
    public static final class Builder {
        ...
        public SunHttp.Builder post() {
            this.method = NetMethod.POST;
            return this;
        }

        /*DELETE*/
        public SunHttp.Builder delete() {
            this.method = NetMethod.DELETE;
            return this;
        }

        /*PUT*/
        public SunHttp.Builder put() {
            this.method = NetMethod.PUT;
            return this;
        }
